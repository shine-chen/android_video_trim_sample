...
import csgi.com.videoedittest.R;
...
public class ExtractDecodeEditEncodeMuxTest_5_0 extends AndroidTestCase {
    private static final String TAG = ExtractDecodeEditEncodeMuxTest_5_0.class.getSimpleName();
    ...
    private static class TestWrapper implements Runnable {
        ...
        private ExtractDecodeEditEncodeMuxTest_5_0 mTest;
        private TestWrapper(ExtractDecodeEditEncodeMuxTest_5_0 test) {
            mTest = test;
        }
        @Override
        public void run() {
         ...
         * Entry point.
         */
        public static void runTest(ExtractDecodeEditEncodeMuxTest_5_0 test) throws Throwable {
            test.setOutputFile();
