...
public class Producer {
    ...
    private static final boolean EnableAudio = false;
    ...
    private static final int OUTPUT_VIDEO_HEIGHT = 320;
    ...
    public interface Listener {
        ...
        void onProductionComplete(String outputFilePath);
        void onProductionError(Exception e);
    }

    private static final boolean bNativeMuxerSupport = (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2);

    private Context context;
    private String inputFilePath;
    private Uri inputFileUri;
    private final String outputFilePath;
    private long startPTUS;
    private long endPTUS;

    private Listener listener;

    public Producer(String input, String output, long start, long end) {
        inputFilePath = input;
    ...
    public Producer(Context context, Uri inputUri, String output, long start, long end) {
    ...
    private MediaExtractor createExtractor() throws IOException {
        ...
        if (inputFilePath != null && !TextUtils.isEmpty(inputFilePath)) {
            extractor.setDataSource(inputFilePath);
        } else if (inputFileUri != null && context != null) {
            extractor.setDataSource(context, inputFileUri, null);
        } else {
     ...
     */
    private MediaMuxer createMuxer(String outputfile) throws IOException {
        return new MediaMuxer(outputfile, MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
    }
    ...
    private class PlayerThread extends Thread {
        ...
        private void prepare() throws IOException {
            ...
            // Video part
            {
                ...
                MediaFormat outputVideoFormat =
                        MediaFormat.createVideoFormat(OUTPUT_VIDEO_MIME_TYPE, OUTPUT_VIDEO_WIDTH, OUTPUT_VIDEO_HEIGHT);
            ...
            muxer = createMuxer(outputFilePath);
        }
        ...
        public void run() {
            ...
            try {
                ...
                // TODO: fix the in-precise seeking, implement frame-drop

                if (startPTUS > 0) {
                    videoExtractor.seekTo(startPTUS, MediaExtractor.SEEK_TO_CLOSEST_SYNC);
                }

                startPTUS = videoExtractor.getSampleTime();

                if (EnableAudio) {
                    if (startPTUS > 0) {
                        audioExtractor.seekTo(startPTUS, MediaExtractor.SEEK_TO_CLOSEST_SYNC);
                    }
                }
            ...
            if (exception != null) {
                ...
                if (listener != null) {
                    listener.onProductionError(exception);
                }
                return;
            }
            ...
            if (listener != null) {
                ...
                listener.onProductionComplete(outputFilePath);
            }
        }
        ...
        private void doExtractDecodeEditEncodeMux() throws Exception{
            ...
            while (!videoEncoderDone || (!audioEncoderDone && EnableAudio)) {
                ...
                while (!videoExtractorDone
                    ...
                    if (size >= 0) {
                        videoDecoder.queueInputBuffer(
                                ...
                                0,
                                size,
                                presentationTime - startPTUS,
                                videoExtractor.getSampleFlags());
                    }
                    videoExtractorDone = size < 0 || !videoExtractor.advance();
                ...
                // ready to mux the frames.
                while (EnableAudio && !audioExtractorDone
                    ...
                    if (presentationTime < endPTUS) {
                        ...
                        size = audioExtractor.readSampleData(decoderInputBuffer, 0);
                        if (VERBOSE) {
                    ...
                    audioExtractorDone = size < 0 || !audioExtractor.advance();
                ...
                while (EnableAudio && !audioDecoderDone && pendingAudioDecoderOutputBufferIndex == -1
                        && (encoderOutputAudioFormat == null || muxing)) {
                    int decoderOutputBufferIndex =
                ...
                while (EnableAudio && pendingAudioDecoderOutputBufferIndex != -1) {
                    if (VERBOSE) {
                ...
                while (!videoEncoderDone
                    ...
                    if (listener != null) {
                        listener.onProgressUpdate((double)(videoEncoderOutputBufferInfo.presentationTimeUs) / (endPTUS - startPTUS));
                    }
                    break;
                }

                // Poll frames from the audio encoder and send them to the muxer.
                while (EnableAudio && !audioEncoderDone
                        && (encoderOutputAudioFormat == null || muxing)) {
                ...
                if (!muxing
                        ...
                        && (encoderOutputAudioFormat != null || !EnableAudio)) {
                    Log.d(TAG, "muxer: adding video track.");
                    outputVideoTrack = muxer.addTrack(encoderOutputVideoFormat);
                    if (EnableAudio && encoderOutputAudioFormat != null) {
